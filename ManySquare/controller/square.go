...
func newSquare(pos *basic.Point) *square {
	return &square{
		position: pos,
		velocity: &basic.Point{X: rand.Float64()*0.01, Y: rand.Float64()*0.01},

		angle: &basic.Point{Z: rand.Float64()},
		angularVelocity: &basic.Point{Z: rand.Float64()*2.0},

		force: basic.Zero(),
		torque: basic.Zero(),

		radius: 0.2,
		color: &colorful.Color{R: 0.9, G: 0.4},
...
func (s *square) faces() (f0, f1, f2, f3 *face) {
	...
	f0 = &face{p0: p1, p1: p0, depth: depth}
	f1 = &face{p0: p2, p1: p1, depth: depth}
	f2 = &face{p0: p3, p1: p2, depth: depth}
	f3 = &face{p0: p0, p1: p3, depth: depth}
